...
public class GameTimer : MonoBehaviour
{
    ...
    void AddCoins(int coinsToAdd)
    {
        ...
        GRNupgrade.money += coinsToAdd;
        UpdateCoinUI();
        SaveGame();

        Debug.Log($"Бот зібрав {coinsToAdd} монет! Всього: {GRNupgrade.money}");
    }
    ...
    void UpdateCoinUI()
    {
        ...
        {
            sp1.moneyText.text = $"{GRNupgrade.money}";
        }
    }
