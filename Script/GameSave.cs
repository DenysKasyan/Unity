...
public class GameSave : MonoBehaviour
{
    ...
    private const string UsingTextKey = "UsingTextActive";
    ...
    {
        if (GRNupgrade.money >= Cent)
        {
            GRNupgrade.money -= Cent;
            script.enabled = true;
            PlayerPrefs.SetInt("money", GRNupgrade.money);
    ...
    {
        button.interactable = GRNupgrade.money >= Cent;
    }
